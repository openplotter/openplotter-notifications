...
setup (
	...
	entry_points={'console_scripts': ['openplotter-notifications=openplotterNotifications.openplotterNotifications:main','openplotter-notifications-viewer=openplotterNotifications.viewer:main','openplotter-notifications-visual=openplotterNotifications.visual:main','openplotter-notifications-sound=openplotterNotifications.sound:main','notificationsPostInstall=openplotterNotifications.notificationsPostInstall:main','notificationsPreUninstall=openplotterNotifications.notificationsPreUninstall:main','openplotter-notifications-read=openplotterNotifications.openplotterNotificationsRead:main','set-notification=openplotterNotifications.setNotification:main']},
	data_files=[('share/applications', ['openplotterNotifications/data/openplotter-notifications.desktop','openplotterNotifications/data/openplotter-notifications-viewer.desktop','openplotterNotifications/data/openplotter-stop-sound.desktop']),('share/pixmaps', ['openplotterNotifications/data/openplotter-notifications.png','openplotterNotifications/data/openplotter-notifications-visual.png','openplotterNotifications/data/openplotter-notifications-viewer.png','openplotterNotifications/data/openplotter-stop-sound.png']),('share/sounds/openplotter', ['openplotterNotifications/data/sounds/bip.mp3','openplotterNotifications/data/sounds/pup-alert.mp3','openplotterNotifications/data/sounds/nuclear-alarm.ogg',])],
	)
